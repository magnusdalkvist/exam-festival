      ...
      <div className={styles.main}>
        ...
        <Collapse.Group className={styles.collapsegroup}>
          ...
          <Collapse title="Q: What makes GreenMark different from other music festivals?">
            <div className={styles.info}>
              <p>
                A: GreenMark is dedicated to promoting sustainability, both environmental and social. We take steps to minimize our impact on the environment and support local organizations working to
